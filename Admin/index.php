...
$query_approved = "SELECT COUNT(*) AS approved_count FROM appoinment WHERE status = 'Pending' ";
...
$query_total = "SELECT COUNT(*) AS total_count FROM appoinment";
...
$query_approved_today = "SELECT COUNT(*) AS approved_today_count FROM appoinment 
                         WHERE status = 'Pending' AND DATE(date) = '$today_date'";
              ...
              <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold"> Welcome, <?php echo htmlspecialchars($_SESSION['admin_username']); ?>!</h3>
                    <h6 class="font-weight-normal mb-0">Admin DashBoard</span></h6>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale">
                <div class="card-body">
                    <p class="mb-4">Pending Appointments</p>
